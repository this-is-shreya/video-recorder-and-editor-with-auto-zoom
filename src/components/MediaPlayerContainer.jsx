...
const MediaPlayerContainer = ({ trackNum }) => {
  ...
  return (
    ...
    >
      ...
      {isTransitioning && _transitionType === transitionType.colouredWaves && (
        <Transition1 />
      )}
      {isTransitioning && _transitionType === transitionType.blurredZoom && (
        <Transition2 />
      )}
      ...
      {isTransitioning && _transitionType === transitionType.blurredFadeIn && (
        <Transition5 />
      )}
