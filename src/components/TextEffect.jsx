...
const TextEffect = () => {
  const { effectsAndTiming, selectedElement, currentEffectsAndTiming } = useContext(AppContext);
  ...
  const [backgroundColor, setBackgroundColor] = useState(currentEffectsAndTiming[0].backgroundColor);
  ...
  return (
    <>
      ...
      {source === "text-title-1" && <TitleCard1 text={text} fontStyle={fontStyle} fontSize={fontSize} color={textColor} bgColor={backgroundColor} />}
      {source === "text-title-2" && <TitleCard2 text={text} fontStyle={fontStyle} fontSize={fontSize} color={textColor} bgColor={backgroundColor} />}
      {source === "text-title-3" && <TitleCard3 text={text} fontStyle={fontStyle} fontSize={fontSize} color={textColor} bgColor={backgroundColor} />}
      {source === "text-title-4" && <TitleCard4 text={text} fontStyle={fontStyle} fontSize={fontSize} color={textColor} bgColor={backgroundColor} />}
      {source === "text-title-5" && <TitleCard5 text={text} fontStyle={fontStyle} fontSize={fontSize} color={textColor} bgColor={backgroundColor} />}
      {source === "text-title-6" && <TitleCard6 text={text} fontStyle={fontStyle} fontSize={fontSize} color={textColor} bgColor={backgroundColor} />}
      {source === "text-title-7" && <TitleCard7 text={text} fontStyle={fontStyle} fontSize={fontSize} color={textColor} bgColor={backgroundColor} />}
      {/* Lower thirds */}
